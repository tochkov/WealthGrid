...
internal fun rememberMarker(
    valueFormatter: DefaultCartesianMarker.ValueFormatter =
        DefaultCartesianMarker.ValueFormatter.Companion.default(),
    showIndicator: Boolean = true,
): CartesianMarker {
    val labelBackgroundShape =
        markerCorneredShape(CorneredShape.Corner.Companion.Rounded)
    val labelBackground =
    ...
    val indicatorCenterComponent =
        rememberShapeComponent(shape = CorneredShape.Companion.Pill)
